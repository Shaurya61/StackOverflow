...
const Chatbot = ({ setIsOpen, isVerified, setIsVerified }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://stackoverflow-stripe.onrender.com/chatbot/', {
        method: 'POST',
        headers: {
  ...
  const handleEmailSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch('https://stackoverflow-stripe.onrender.com/otp/sendOTP', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const handleOTPSubmit = async (e) => {
    e.preventDefault()
    const response = await fetch('https://stackoverflow-stripe.onrender.com/otp/verifyOTP', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
